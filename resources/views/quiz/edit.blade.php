...
<style>
    ...
    <section class="section">
        ...
        <div class="section-body">
            ...
            <p class="section-lead">Seluruh soal dapat diedit sedinamis mungkin atau <a href="{{ route('quiz.create') }}"> generate soal baru</a></p>
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-header-action">
                                <div class="dropdown">
                                    <a href="#" data-toggle="dropdown" class="btn btn-sm btn-success dropdown-toggle" aria-expanded="false"><i class="fas fa-download mr-2"></i>Export Soal</a>
                                    <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 26px, 0px); top: 0px; left: 0px; will-change: transform;">
                                      <a href="{{ route('quiz.pdf', ['id' => $data['quiz']['id']]) }}" class="dropdown-item has-icon"><i class="fas fa-file-pdf"></i>PDF</a>
                                      {{-- <a href="#" class="dropdown-item has-icon"><i class="fas fa-file-word"></i> Word</a>
                        ...
                        <div class="card-body">
                            <div class="row-lg-12">
                                <form action="{{ route('quiz.update', ['quiz' => $data['quiz']['id']]) }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    @method('put')
