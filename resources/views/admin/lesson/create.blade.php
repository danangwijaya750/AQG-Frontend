                        ...
                        <form method="POST" action="{{ route('admin.lesson.store') }}">
                            ...
                            <div class="form-row col-md-12">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="title" placeholder="Isikan Nama Mata Pelajaran">
                                    </div>
                            ...
                            <div class="card-footer text-right">
                                <button id="btn_generate" class="btn btn-icon icon-right btn-primary" type="submit">Buat Mata Pelajaran <i class="fas fa-graduation-cap"></i></button>
                            </div>
                        </form>
                        </div>
                        </div>
