            ...
            <div class="row col-lg-12">
                <div class="col-lg-7 col-md-7 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                        <form method="POST" action="{{ route('admin.study.store') }}">
                            @csrf
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="selectgroup w-100">
                                    ...
                                    <label class="selectgroup-item">
                                        <input type="radio" id="sharing" name="is_sharing" value="1" class="selectgroup-input">
                                ...
                                <table id="quiz_table" class="table table-responsive table-bordered">
                                    ...
                                    @foreach ($data['study'] as $study )
                                      <tr>
                                        ...
                                        <td><a href="{{ route('admin.study.edit', $study->id) }}"><i class="fas fa-arrow-right    "></i></a></td>
                                      </tr>
                                      @endforeach
                                    </tbody>
                                  </table>
