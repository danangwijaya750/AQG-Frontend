            ...
            <div class="row col-lg-12">
                <div class="col-lg-7 col-md-7 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                        <form method="POST" action="{{ route('study.update' ,['study' => $data['study']['id']]) }}" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                                ...
                                <table id="quiz_table" class="table table-responsive table-bordered">
                                    ...
                                    @foreach ($data['studies'] as $study )
                                      <tr>
                                        ...
                                        <td><a href="{{ route('study.edit', ['study' => $study->id]) }}"><i class="fas fa-arrow-right    "></i></a></td>
                                      </tr>
                                      @endforeach
                                    </tbody>
                                  </table>
