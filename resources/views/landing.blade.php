...
@section('app')
        ...
        <div class="container">
            ...
            <div class="row mt-40">
                <div class="col-lg-12 text-center mt-10">
                    <a href="{{ route('quiz.all') }}" class="btn-branch">Lihat Semua Soal<i class="ml-2 fa fa-angle-right"></i></a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="pt-40" data-aos="fade-up" data-aos-anchor="#app">
        <div class="container">
            ...
            <div class="row mt-40">
                <div class="col-lg-12 text-center mt-10">
                    <a href="{{ route('study.all') }}" class="btn-branch">Lihat Semua Materi <i class="ml-2 fa fa-angle-right"></i></a>
                </div>
            </div>
        </div>
    </section>
