...
class AdminStudyController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.studies.create', compact('data'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return RedirectHelper::redirectRouteStatus('admin.study.index', 'success', 'Materi berhasil ditambah !');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.studies.edit',compact('data'));
    ...
    public function update(Request $request, $id)
    {
        ...
        return RedirectHelper::redirectRouteStatus('admin.study.index', 'success', 'Materi berhasil diedit !');
    }
